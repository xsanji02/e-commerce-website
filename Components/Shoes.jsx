...
export const Shoes = () => {
  return (
    <div className="shoes-border">
      <div className="card-container">
        <div className="card">
          <img src={product.shoes1.image} className="card-image" alt="Card Image" />
        ...
        <div className="card-container">
          ...
          <div class="card">
            <img src={product.shoes7.image} class="card-image" alt="images" />
            <div class="card-body">
              <h5 class="card-title">{product.shoes7.title}</h5>
              <p class="card-text">{product.shoes7.description}</p>
              <div className="card-section">
                <div className="price-div">
                  <p class="card-text text-warning fw-bold ">
                    <span class="before-price">
                      ${product.shoes7.beforePrice}
                    </span>
                    ${product.shoes7.price}
                  </p>
                </div>
                <div className="icon-div">
                  <FaShoppingBag className="button-cart" />
              ...
              <div className="ratings">
                ...
                <BiSolidStar className="start-icon" />
                <BiSolidStar className="start-icon" />(
                <span>{product.shoes7.rating} reviews</span>)
              </div>
              <button type="button" class="btn btn-warning mt-2">
                BUY NOW
              </button>
          ...
          <div class="card">
            <img src={product.shoes8.image} class="card-image" alt="images" />
            <div class="card-body">
              <h5 class="card-title">{product.shoes8.title}</h5>
              <p class="card-text">{product.shoes8.description}</p>
              <div className="card-section">
                <div className="price-div">
                  <p class="card-text text-warning fw-bold ">
                    <span class="before-price">
                      ${product.shoes8.beforePrice}
                    </span>
                    ${product.shoes8.price}
                  </p>
                </div>
                <div className="icon-div">
                  <FaShoppingBag className="button-cart" />
              ...
              <div className="ratings">
                ...
                <BiSolidStar className="start-icon" />
                <BiSolidStar className="start-icon" />(
                <span>{product.shoes8.rating} reviews</span>)
              </div>
              <button type="button" class="btn btn-warning mt-2">
                BUY NOW
              </button>
